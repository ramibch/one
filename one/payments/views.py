...
from one.plans.templatetags.pricing import get_currency_and_amount_for_stripe
...
def create_stripe_session(request, plan: Model):
    ...
    try:
        ...
        # ! Note that Stripe will always create a
        #   new Customer Object if customer id not provided
