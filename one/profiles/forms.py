...
from utils.forms import build_form_widgets
...
def get_child_model_and_form(Klass):
    ...
    Model = getattr(profile_models, Klass) if isinstance(Klass, str) else Klass
...
class LanguageAbilityForm(BaseChildFormSet):
    ...
    class Meta:
        fields = ["name", "level"]
        model = profile_models.LanguageAbility
...
class EducationForm(BaseChildFormSet):
    ...
    class Meta:
        ...
        model = profile_models.Education
...
class ExperienceForm(BaseChildFormSet):
    ...
    class Meta:
        ...
        model = profile_models.Experience
...
class AchievementForm(BaseChildFormSet):
    ...
    class Meta:
        fields = ["date", "title"]
        model = profile_models.Achievement
...
class PublicationForm(BaseChildFormSet):
    ...
    class Meta:
        ...
        model = profile_models.Publication
