...
{% if profile.about %}
\space
\section*{\faIcon{user} {{ profile.about_label }} }
{{ profile.about|latex_escape }}
{% endif %}


{% if profile.candidateexperience_set.count() > 0 %}
\section*{\faIcon{building} {{ profile.experience_label }} }
...
\section*{\faIcon{graduation-cap} {{ profile.education_label }}}
...
\section*{\faIcon{cogs} {{ profile.skill_label }}}
\begin{center}
...
\section*{\faIcon{certificate} {{ profile.certificate_label }}}
...
\section*{\faIcon{language} {{ profile.language_label }}}
